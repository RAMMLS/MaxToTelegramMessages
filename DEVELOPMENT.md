...
## Проверяемый snapshot 2026-08-22
...
3. Авторизованный reviewer открывает release PR `integration/nightly -> main`,
   сверяет Checks и результаты account-gated smoke.
4. Только после этого PR может быть слит в `main`.
